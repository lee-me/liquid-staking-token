...
function stakeNow(ticker) {
    ...
    const protocolName = ticker ? lstData.find(item => item.ticker === ticker).name : 'LST';
    alert(`Stake ${solAmount} SOL to ${protocolName}\n\nThis will redirect you to the staking page.\nIn a production environment, this would connect to your wallet and stake.`);
}
...
async function connectWallet() {
    try {
        if (!wallet) {
            alert('请先安装Solana钱包，如Phantom或Solflare');
            return;
        }
...
function renderDashboard() {
    ...
    if (dashboard) {
        dashboard.innerHTML = `
            <div class="container">
                <h2>📊 个人仪表盘</h2>
                <p class="section-subtitle">您的 DeFi 资产和收益概览</p>
                ...
                <div class="dashboard-section">
                    <div class="dashboard-overview">
                        <div class="dashboard-card">
                            ...
                            <div class="card-value">$2,458.75</div>
                            <div class="card-change positive">+2.5% 今日</div>
                        </div>
                        <div class="dashboard-card">
                            <div class="card-header">
                                <div class="card-icon">📈</div>
                            ...
                            <div class="card-value">$125.30</div>
                            <div class="card-change positive">+15.2% 本月</div>
                        </div>
                        <div class="dashboard-card">
                            <div class="card-header">
                                <div class="card-icon">⚡</div>
                            ...
                            <div class="card-value">1.5 SOL</div>
                            <div class="card-change positive">7.2% APY</div>
                        </div>
                        <div class="dashboard-card">
                            <div class="card-header">
                                <div class="card-icon">🎯</div>
                                <div class="card-title">NFTs</div>
                            </div>
                            <div class="card-value">3</div>
                            <div class="card-change positive">+1 本月</div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-charts">
                        <div class="dashboard-chart">
                            ...
                            <div class="chart-container">
                                <div style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; background: var(--input-bg); border-radius: var(--border-radius-md);">
                                    <div style="width: 200px; height: 200px; background: conic-gradient(#6366f1 30%, #8b5cf6 30% 50%, #ec4899 50% 75%, #f97316 75%); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                                        <div style="width: 120px; height: 120px; background: var(--card-bg); border-radius: 50%; display: flex; flex-direction: column; align-items: center; justify-content: center; font-size: 0.875rem;">
                                            <div style="font-weight: 600;">资产分布</div>
                                            <div style="font-size: 0.75rem; color: var(--text-secondary);">4 种资产</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
